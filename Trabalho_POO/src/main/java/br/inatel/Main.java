...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            ParticipacaoCampeonato p1 = new ParticipacaoCampeonato(time1.getNome(), tecnico1.cpf, camp1.getNome());
            ParticipacaoCampeonato p2 = new ParticipacaoCampeonato(time2.getNome(), tecnico2.cpf, camp2.getNome());
            ParticipacaoCampeonato p3 = new ParticipacaoCampeonato(time3.getNome(), tecnico3.cpf, camp1.getNome());
